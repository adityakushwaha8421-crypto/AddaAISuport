...
/** A problem with a match or contest outcome. The team handles these; the agent never answers them. */
...
/** A problem with a match or contest, read from the words. Checked before the money direction: a match problem is never a deposit or withdrawal case. */
